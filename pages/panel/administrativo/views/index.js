...
const Views = React.memo(() => {
  ...
  const codeBodyTemplate = (rowData) => rowData.id
  ...
  const header = (
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
      <h5 className="m-0">Vistas</h5>

      <div className="flex flex-wrap mt-2 md:mt-0">
        {
          permissions?.views?.write === "1"
  ...
  let broadcrumbData = { label: 'Vistas', icon: 'pi pi-fw pi-eye', url: routes.views };
  return (
    <>
        ...
        <div className="col-12">
          <div className="card">
            ...
            <DataTable
              ...
              emptyMessage="No se encontraron vistas."
              header={header}
              size='small'
              removableSort
            ...
            <Dialog maximizable visible={itemDialog} style={{ width: '450px' }} header={nuevo ? 'Nueva Vista' : 'Editar Vista'} modal className="p-fluid" footer={itemDialogFooter} onHide={hideDialog}>
              <div className={classNames({ 'p-input-filled': item.description }, 'field')}>
                <label htmlFor="item">Vista</label>
                <InputText
                  id="item"
